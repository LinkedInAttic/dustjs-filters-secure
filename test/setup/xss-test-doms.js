var contextTests = [
  ...
  },
  {
    ...
    source:   "<ul>{#users}<li><a href='http://some.web.site.com/{id|u}'>View user {id}</a></li>{/users}</ul>",
    context:  { users : [ {id : "Bill"},
                          {id : "'/><script>alert(1);</script>"}
                        ]
              },
    expected: function(doc){
                return doc.body.getElementsByTagName("script").length == 0;
              },
  ...
  },
  {
    ...
    source:   "<script id='test_script'>var js_encode_html_template = '{templ|h|j|s}';</script><p id='container'></p>",
  ...
  },
  {
    ...
    source:   "<script id='test_script'>var essential_variable = '{templ|j|s}';</script>",
